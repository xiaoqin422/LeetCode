...
//</ul>
//<div><div>Related Topics</div><div><li>数组</li><li>双指针</li></div></div><br><div><li>👍 1311</li><li>👎 0</li></div>
 ...
 * [27]remove-element
 * @author 秦笑笑
 * @date 2022-05-02 20:13:40
 */
public class P027_RemoveElement {
    public static void main(String[] args) {
        Solution solution = new P027_RemoveElement().new Solution();
    }
